    ...
    <div class="loginInput">
      ...
      <div class="loginInputArea">
        ...
        <input
          ...
          id="inputPassword"
          class="password"
          style="margin-left: 5px; width: 298px"
        ...
        <i
          ...
          v-show="!showPassword"
          @click="show()"
          style="position: absolute; left: 51%; top: 49.5%"
        ></i>
        <i
        ...
        <i
          class="fa-solid fa-eye-slash eye"
          v-show="!showPasswordTwo"
          @click="showTwo()"
          style="position: absolute; left: 51%; top: 56.5%"
        ></i>
        <i
          class="fa-solid fa-eye eye"
          v-show="showPasswordTwo"
        ...
        <input
          type="text"
          placeholder="請輸入西元生日(ex:20000101)"
          id="inputBirthday"
          class="birthday"
