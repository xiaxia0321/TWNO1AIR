...
<template>
  <div class="big">
    <div class="top">
      ...
      <p>2.樂狗航空其他銷售通路，如官方App，或許能提供更優惠價格。</p>
      <p>
    ...
    <!-- 下面是回程區 -->
    <div class="topbk"><h2>回程： 熊本 - 台北</h2></div>
    <div class="datebk">
      <span>2月4日周日</span>
    </div>
    <div class="midbk">
      <div class="m1bk">
        <div class="a1bk">
          <p class="p1bk">JX841</p>
          <p class="p1bk">2024年2月4日</p>
          <p class="timebk">19:00</p>
          <p class="nationbk">FUK</p>
        </div>
        <div class="a2bk"><i class="fa-solid fa-arrow-right"></i></div>
        <div class="a3bk">
          <p class="p1bk">2 小時 40 分鐘</p>
          <p class="p1bk">2024年2月4日</p>
          <p class="timebk">20:40</p>
      ...
      <div class="m2bk">
        <h3>經濟艙</h3>
        <span>TWD</span>
        <span class="moneybk">16,665</span>
        <span>起</span>
      </div>
    </div>
  </div>
