...
<template>
    <div class="search">
        <div class="searchFor">
            <br>
            <h1>搭乘樂GO航空從台北飛往洛杉磯 ，自 TWD27,052* 起！</h1>
        </div>
        <div class="condition">
    ...
    <div class="content">
        <div class="ticket">
            <span class="top">去程：臺北-舊金山</span>
            <div class="go">
                <p>　　經濟艙</p>
                <p>　　JX012　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　10小時45分鐘</p>
                <p>　　2024年2月1日　　　　　　　　　　　　　　　　　　　　　　　　　　　　　2024年2月1日</p>
                <h3>　23:30　　　　　　　　　　　　　　　　　　18:15</h3>
                <h3>　TPE　　　　　　　　　　　　　　　　　　　SFO</h3>
                <div class="goBtn">
            ...
            <br>
            <span class="bottom">回程：舊金山-臺北</span>
            <div class="back">
                <p>　　經濟艙</p>
                <p>　　JX011　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　13小時50分鐘</p>
                <p>　　2024年2月24日　　　　　　　　　　　　　　　　　　　　　　　　　　　　　2024年2月26日</p>
                <h3>　23:40　　　　　　　　　　　　　　　　　　05:30</h3>
                <h3>　SFO　　　　　　　　　　　　　　　　　　　TPE</h3>
                <div class="backBtn">
                    <button type="button">訂購</button>
            ...
            <div class="notice">
                ...
                <p>4、樂GO航空保留隨時修訂或終止各種票價產品、優惠及相關規則之權利，詳見「運送條款」。</p>
                <p>5、以上規定僅適用於搭乘樂GO航空實際營運之航班。</p>
                <p>6、樂GO航空關心每位旅客的健康，如有發燒、咳嗽、呼吸急促等身體不適，請暫緩搭機。各國入境相關規定及簽證須知，請參考「外交部領事事務局」。</p>
