...
export default {
  ...
  methods: {
    ...
    updateDepartureAirport() {
      // 在出發地改變時更新機場縮寫
      this.updateAirportAbbreviation(
        "da",
        this.plane.departureAirport,
        "departureLocation"
      );
  ...
  <div class="big">
    <div class="left">
      <div class="l1">
        ...
        <input type="checkbox" class="chek" v-model="plane.isOneway" @change="ccc" />
      </div>

      <div class="l2">
        <input type="date" v-model="plane.departureDate" style=" height: 2rem" :min="this.today"
          @change="updateMinDate" />

        <select name="" id="" v-model="plane.departureAirport" @change="updateDepartureAirport">
        ...
        <input type="text" disabled v-model="plane.departureLocation" />
      ...
      <option value="舊金山,美國">舊金山,美國</option>
        ...
        <input type="text" v-model="plane.da" disabled />
    ...
    <div class="right">
      ...
      <div class="l2">
        ...
        <select name="" id="" v-model="plane.arrivalAirport" @change="updateArrivalAirport" p>
          <option value="桃園國際機場">桃園國際機場</option>
          <option value="澳門國際機場">澳門國際機場</option>
          <option value="成田國際機場">成田國際機場</option>
          <option value="關西國際機場">關西國際機場</option>
        ...
        <input type="text" disabled v-model="plane.arrivalLocation" />
      ...
      <option value="舊金山,美國">舊金山,美國</option>
        ...
        <input type="text" v-model="plane.aa" disabled />
